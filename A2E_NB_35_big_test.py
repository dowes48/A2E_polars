...
df = pl.read_csv(r'data/a2e_mega_data_35.csv', try_parse_dates = True)
...
## df = df.filter(pl.col('UID').is_in([12358, 12360, 12361, 22229, 22423, 22424, 33027, 
##                        33028, 42496, 42497, 52674, 62982,  62983, 62984, 62985, 72662]))
...
df.write_csv(r'data/a2e_mega_data_results_' + itr + '.csv')
